...
export const SECURITY_ROUTES: Routes = [
...

  {
    ...
    loadComponent: () => import('./access-policies/access-policies').then((m) => m.AccessPolicies),
  },

  {
    ...
    loadComponent: () => import('./token-activity/token-activity').then((m) => m.TokenActivity),
  },

  {
    ...
    loadComponent: () => import('./device-activity/device-activity').then((m) => m.DeviceActivity),
  },
];
